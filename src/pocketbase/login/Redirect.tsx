    ...
    client.users.authViaOAuth2(
      ...
      .then((response) => {
        ...
        client.records.update("profiles",response.user.profile?.id as string,
           {name: response.meta.name,avatarUrl: response.meta.avatarUrl}
          )
          .then((res) => {console.log(" successfully updated profi;e",res);
          })
      ...
      .catch((e) => {console.log("error logging in with provider  == ",e);
      });
  }
  if (user) {
